...
class Motors_c {
  ...
  // 
     ...
     void setlMotorforward(float leftm, float dem,float demm) {
       unsigned char DIR;
       if(dem<0 && demm==1){
       DIR=FWD;
       }else if(dem>0 && demm==1){
         DIR=REV;
       }else DIR=FWD;          
      ...
      void setrMotorforward(float rightm,float dem,float demm) {
       unsigned char DIR;
       if(dem<0 && demm==1){
       DIR=REV;
       }else if(dem>0 && demm==1){
